...
import Sport from "./discoverSport/Sports";
...
const WomenMain = () => {
  ...
  // open Shoe
  const [openShoe, setOpenShoe] = useState<boolean>(false);

  const handleOpenShoe = () => {
    setOpenShoe((prev) => !prev);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className=" mt-2 text-2xl font-semibold">Women</h1>
